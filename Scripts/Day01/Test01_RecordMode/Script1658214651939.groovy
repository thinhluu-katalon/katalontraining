...
WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/section_Make Appointment                   _57f49e'))
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'demo')
