...
CustomKeywords.'com.kms.katalon.keyword.applitools.BasicKeywords.checkWindow'('Test01')
...
CustomKeywords.'com.kms.katalon.keyword.applitools.BasicKeywords.checkWindow'('Test02')
